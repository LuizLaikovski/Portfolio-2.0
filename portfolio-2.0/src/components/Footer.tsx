...
const Footer = () => {
    return (
        <>
            <footer id="contact" className="w-full h-[86dvh] flex-col flex items-center justify-center">
                <div className="flex justify-center items-center w-[100%]">
                    <div className="p-10 mr-[25%]">
                        <div className="w-[30dvw] flex mt-6 mb-6">
                        ...
                        <div className="w-[30dvw] flex mt-6 mb-6">
                            ...
                            <a className="text-2xl cursor-pointer pl-2.5" href="mailto:luizlaikovski@gmail.com">E-Mail: luizlaikovski@gmail.com</a><br></br>
                        </div>
                        <div className="w-[30dvw] flex mt-6 mb-6">
